                    ...
                    const processElement = () => {
                        ...
                        if (children.length === 0) {
                                ...
                                ((
                                    ...
                                    ((
                                        ...
                                        Gidentifier(node, children, ($) => {
                                            const _name = $
                                            let optional: tast.TVGtype_typeLiteral$_index$_key$_type<Annotation> = null
                                            const setOptional = () => {
                                                Gtype(node, children, ($) => {
                                                    optional = $
                                                })
                                        ...
                                        ($) => {
                                            const _key = $
                                            let optional: tast.TVGtype_typeLiteral$_index$_type<Annotation> = null
                                            const setOptional = () => {
                                                Gtype(node, children, ($) => {
                                                    optional = $
                                                })
                            ...
                            const choose_property = () => {
                                ...
                                ((
                                    $: uast.Node<Annotation>,
                                    callback: ($: tast.TNGtype_typeLiteral$_property$<Annotation>) => void,
                                ): void => {
                                    const node = $
                                    const children: uast.Node<Annotation>[] = []
                                    $.children.forEach(($) => { children.push($) })
                                    ...
                                    let currentChild: uast.Node<Annotation> | undefined
                                    let nextChild: uast.Node<Annotation> | undefined
                                    const sequenceEnd = ($: tast.TVTGtype_typeLiteral$_property$<Annotation>) => {
                                        callback({
                                            annotation: node.annotation,
                                            content: $,
                                        })
                                    ...
                                    ((
                                        $: uast.Node<Annotation>,
                                        callback: ($: tast.TNGtype_typeLiteral$_property$_readonly$<Annotation>) => void,
                                    ): void => {
                                        const node = $
                                        const children: uast.Node<Annotation>[] = []
                                        $.children.forEach(($) => { children.push($) })
                                        ...
                                        ($) => {
                                            ...
                                            ((
                                                $: uast.Node<Annotation>,
                                                callback: ($: tast.TNGtype_typeLiteral$_property$_name$<Annotation>) => void,
                                            ): void => {
                                                const node = $
                                                const children: uast.Node<Annotation>[] = []
                                                $.children.forEach(($) => { children.push($) })
                                                ...
                                                ($) => {
                                                    const _name = $
                                                    let optional: tast.TVGtype_typeLiteral$_property$_questionToken<Annotation> = null
                                                    const setOptional = () => {
                                                        currentChild = children.pop()
                                                        if (currentChild === undefined) {
                                                            reportMissingToken({
                                                        ...
                                                        ((
                                                            $: uast.Node<Annotation>,
                                                            callback: ($: tast.TNGtype_typeLiteral$_property$_questionToken$<Annotation>) => void,
                                                        ): void => {
                                                            const node = $
                                                            const children: uast.Node<Annotation>[] = []
                                                            $.children.forEach(($) => { children.push($) })
                                                    ...
                                                    pr.cc(optional, ($) => {
                                                        ...
                                                        let optional: tast.TVGtype_typeLiteral$_property$_type<Annotation> = null
                                                        const setOptional = () => {
                                                            Gtype(node, children, ($) => {
                                                                optional = $
                                                            })
                    ...
                    const processElement = () => {
                        ...
                        ((
                            ...
                            ((
                                ...
                                let currentChild: uast.Node<Annotation> | undefined
                                let nextChild: uast.Node<Annotation> | undefined
                                const choiceEnd_Gtype_union$$_state$ = ($: tast.TVTGtype_union$$_state$<Annotation>) => {
                                    callback({
                                        annotation: node.annotation,
                                        content: $,
                                    })
                                ...
                                if (children.length === 0) {
                                    ...
                                    const choose_string = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.TNGtype_union$$_state$_string$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
