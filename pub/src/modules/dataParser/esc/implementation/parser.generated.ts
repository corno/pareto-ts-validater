    ...
    function Ginitialization(
        ...
        if (children.length === 0) {
            reportMissingToken({
                ...
                kindNameOptions: ["ArrayLiteralExpression", "FalseKeyword", "Identifier", "NoSubstitutionTemplateLiteral", "NumericLiteral", "ObjectLiteralExpression", "TrueKeyword"],
            })
            return
        } else {
            ...
            const choose_arrayLiteral = () => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.TNGinitialization_arrayLiteral$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
                    ...
                    let currentChild: uast.Node<Annotation> | undefined
                    let nextChild: uast.Node<Annotation> | undefined
                    const elements: tast.TVGinitialization_arrayLiteral$<Annotation> = []
            ...
            const choose_false = () => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.TNGinitialization_false$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
            ...
            const choose_noSubstitutionTemplateLiteral = () => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.TNGinitialization_noSubstitutionTemplateLiteral$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
            ...
            const choose_numericLiteral = () => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.TNGinitialization_numericLiteral$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
            ...
            const choose_objectLiteral = () => {
                ...
                ((
                    ...
                    let currentChild: uast.Node<Annotation> | undefined
                    let nextChild: uast.Node<Annotation> | undefined
                    const elements: tast.TVGinitialization_objectLiteral$<Annotation> = []
                    const processElement = () => {
                        currentChild = children.pop()
                        if (currentChild === undefined) {
                            reportMissingToken({
                        ...
                        ((
                            ...
                            const choiceEnd_Ginitialization_objectLiteral$$_name = ($: tast.TVTGinitialization_objectLiteral$$_name<Annotation>) => {
                                const _name = $
                                Ginitialization(node, children, ($) => {
                            ...
                            if (children.length === 0) {
                                ...
                                const choose_identifier = () => {
                                    ...
                                    ((
                                        $: uast.Node<Annotation>,
                                        callback: ($: tast.TNGinitialization_objectLiteral$$_name_identifier$<Annotation>) => void,
                                    ): void => {
                                        const node = $
                                        const children: uast.Node<Annotation>[] = []
                                        $.children.forEach(($) => { children.push($) })
                                ...
                                const choose_stringLiteral = () => {
                                    ...
                                    ((
                                        $: uast.Node<Annotation>,
                                        callback: ($: tast.TNGinitialization_objectLiteral$$_name_stringLiteral$<Annotation>) => void,
                                    ): void => {
                                        const node = $
                                        const children: uast.Node<Annotation>[] = []
                                        $.children.forEach(($) => { children.push($) })
            ...
            const choose_true = () => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.TNGinitialization_true$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
            ...
            switch (nextChild.kindName) {
                ...
                default: {
                    reportUnexpectedChild({
                        path: "Ginitialization",
                        child: nextChild,
                        expected: ["ArrayLiteralExpression", "FalseKeyword", "Identifier", "NoSubstitutionTemplateLiteral", "NumericLiteral", "ObjectLiteralExpression", "TrueKeyword"],
                    })
                }
            }
        }
    ...
    if ($.kindName !== "SourceFile") {
        ...
        ((
            ...
            ((
                    ...
                    if (children.length === 0) {
                        ...
                        const choose_named = () => {
                            ...
                            ((
                                ...
                                let currentChild: uast.Node<Annotation> | undefined
                                let nextChild: uast.Node<Annotation> | undefined
                                const elements: tast.TVroot_import$_clause$_named$<Annotation> = []
                                const processElement = () => {
                                    currentChild = children.pop()
                                    if (currentChild === undefined) {
                                        reportMissingToken({
                                    ...
                                    ((
                                        ...
                                        Gidentifier(node, children, ($) => {
                                            const _name = $
                                            let optional: tast.TVroot_import$_clause$_named$$_as<Annotation> = null
                                            const setOptional = () => {
                                                Gidentifier(node, children, ($) => {
                                                    optional = $
                                                })
                ...
                ($) => {
                    const _import = $
                    const elements: tast.TVroot_variables<Annotation> = []
                    const processElement = () => {
                        currentChild = children.pop()
                        if (currentChild === undefined) {
                            reportMissingToken({
                            ...
                            ((
                                ...
                                ($) => {
                                    ...
                                    ((
                                        ...
                                        let currentChild: uast.Node<Annotation> | undefined
                                        let nextChild: uast.Node<Annotation> | undefined
                                        const elements: tast.TVroot_variables$_variableDeclarationList$<Annotation> = []
                                        const processElement = () => {
                                            currentChild = children.pop()
                                            if (currentChild === undefined) {
                                                reportMissingToken({
                                                ...
                                                ((
                                                    ...
                                                    ($) => {
                                                        ...
                                                        ((
                                                            ...
                                                            ($) => {
                                                                const _type = $
                                                                let optional: tast.TVroot_variables$_variableDeclarationList$$_one<Annotation> = null
                                                                const setOptional = () => {
                                                                    Ginitialization(node, children, ($) => {
                                                                        optional = $
                                                                    })
