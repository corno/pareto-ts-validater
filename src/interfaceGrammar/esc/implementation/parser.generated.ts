...
export function parse<Annotation>(
    ...
    function GfunctionType(
        ...
        callback: ($: tast.GfunctionType<Annotation>) => void,
    ): void {
        ...
        ((
            $: uast.Node<Annotation>,
            callback: ($: tast.NGfunctionType$<Annotation>) => void,
        ): void => {
            const node = $
            ...
            let currentChild: uast.Node<Annotation> | undefined
            let nextChild: uast.Node<Annotation> | undefined
            const sequenceEnd = ($: tast.VTGfunctionType$<Annotation>) => {
                callback({
                    annotation: node.annotation,
                    content: $,
                })
            }
            const elements: tast.VGfunctionType$_parameters<Annotation> = []
            const processElement = () => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.NGfunctionType$_parameters$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
                    ...
                    let currentChild: uast.Node<Annotation> | undefined
                    let nextChild: uast.Node<Annotation> | undefined
                    const sequenceEnd = ($: tast.VTGfunctionType$_parameters$<Annotation>) => {
                        callback({
                            annotation: node.annotation,
                            content: $,
                        })
                    ...
                    Gidentifier(node, children, ($) => {
                        const _name = $
                        const choiceEnd_GfunctionType$_parameters$_type = ($: tast.VTGfunctionType$_parameters$_type<Annotation>) => {
                            const _type = $
                            sequenceEnd({
                                "name": _name,
                                "type": _type,
                        ...
                        if (children.length === 0) {
                            ...
                            const choose_type = () => {
                                const choiceEnd_GfunctionType$_parameters$_type_type = ($: tast.VTGfunctionType$_parameters$_type_type<Annotation>) => {
                                ...
                                if (children.length === 0) {
                                    ...
                                    const choose_array = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_array$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                    ...
                                    const choose_boolean = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_boolean$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                    ...
                                    const choose_string = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_string$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                    ...
                                    const choose_number = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_number$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                    ...
                                    const choose_typeLiteral = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                            ...
                                            let currentChild: uast.Node<Annotation> | undefined
                                            let nextChild: uast.Node<Annotation> | undefined
                                            const elements: tast.VGfunctionType$_parameters$_type_type_typeLiteral$<Annotation> = []
                                            const processElement = () => {
                                                const choiceEnd_GfunctionType$_parameters$_type_type_typeLiteral$ = ($: tast.VTGfunctionType$_parameters$_type_type_typeLiteral$<Annotation>) => {
                                                    elements.push($)
                                                }
                                                if (children.length === 0) {
                                                    reportMissingToken({
                                                    ...
                                                    const choose_index = () => {
                                                        ...
                                                        ((
                                                            $: uast.Node<Annotation>,
                                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$_index$<Annotation>) => void,
                                                        ): void => {
                                                            const node = $
                                                            const children: uast.Node<Annotation>[] = []
                                                            $.children.forEach(($) => { children.push($) })
                                                            ...
                                                            let currentChild: uast.Node<Annotation> | undefined
                                                            let nextChild: uast.Node<Annotation> | undefined
                                                            const sequenceEnd = ($: tast.VTGfunctionType$_parameters$_type_type_typeLiteral$_index$<Annotation>) => {
                                                                callback({
                                                                    annotation: node.annotation,
                                                                    content: $,
                                                                })
                                                            ...
                                                            ((
                                                                $: uast.Node<Annotation>,
                                                                callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$_index$_key$<Annotation>) => void,
                                                            ): void => {
                                                                const node = $
                                                                const children: uast.Node<Annotation>[] = []
                                                                $.children.forEach(($) => { children.push($) })
                                                                ...
                                                                let currentChild: uast.Node<Annotation> | undefined
                                                                let nextChild: uast.Node<Annotation> | undefined
                                                                const sequenceEnd = ($: tast.VTGfunctionType$_parameters$_type_type_typeLiteral$_index$_key$<Annotation>) => {
                                                                    callback({
                                                                        annotation: node.annotation,
                                                                        content: $,
                                                                    })
                                                                ...
                                                                Gidentifier(node, children, ($) => {
                                                                    const _name = $
                                                                    let optional: tast.VGfunctionType$_parameters$_type_type_typeLiteral$_index$_key$_type<Annotation> = null
                                                                    const setOptional = () => {
                                                                        Gtype(node, children, ($) => {
                                                                            optional = $
                                                                        })
                                                                ...
                                                                ($) => {
                                                                    const _key = $
                                                                    let optional: tast.VGfunctionType$_parameters$_type_type_typeLiteral$_index$_type<Annotation> = null
                                                                    const setOptional = () => {
                                                                        Gtype(node, children, ($) => {
                                                                            optional = $
                                                                        })
                                                    ...
                                                    const choose_property = () => {
                                                        ...
                                                        ((
                                                            $: uast.Node<Annotation>,
                                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$_property$<Annotation>) => void,
                                                        ): void => {
                                                            const node = $
                                                            const children: uast.Node<Annotation>[] = []
                                                            $.children.forEach(($) => { children.push($) })
                                                            ...
                                                            let currentChild: uast.Node<Annotation> | undefined
                                                            let nextChild: uast.Node<Annotation> | undefined
                                                            const sequenceEnd = ($: tast.VTGfunctionType$_parameters$_type_type_typeLiteral$_property$<Annotation>) => {
                                                                callback({
                                                                    annotation: node.annotation,
                                                                    content: $,
                                                                })
                                                            ...
                                                            ((
                                                                $: uast.Node<Annotation>,
                                                                callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$_property$_readonly$<Annotation>) => void,
                                                            ): void => {
                                                                const node = $
                                                                const children: uast.Node<Annotation>[] = []
                                                                $.children.forEach(($) => { children.push($) })
                                                                ...
                                                                ($) => {
                                                                    ...
                                                                    ((
                                                                        $: uast.Node<Annotation>,
                                                                        callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$_property$_name$<Annotation>) => void,
                                                                    ): void => {
                                                                        const node = $
                                                                        const children: uast.Node<Annotation>[] = []
                                                                        $.children.forEach(($) => { children.push($) })
                                                                        ...
                                                                        ($) => {
                                                                            const _name = $
                                                                            let optional: tast.VGfunctionType$_parameters$_type_type_typeLiteral$_property$_questionToken<Annotation> = null
                                                                            const setOptional = () => {
                                                                                currentChild = children.pop()
                                                                                if (currentChild === undefined) {
                                                                                    reportMissingToken({
                                                                                ...
                                                                                ((
                                                                                    $: uast.Node<Annotation>,
                                                                                    callback: ($: tast.NGfunctionType$_parameters$_type_type_typeLiteral$_property$_questionToken$<Annotation>) => void,
                                                                                ): void => {
                                                                                    const node = $
                                                                                    const children: uast.Node<Annotation>[] = []
                                                                                    $.children.forEach(($) => { children.push($) })
                                                                            ...
                                                                            pr.cc(optional, ($) => {
                                                                                ...
                                                                                let optional: tast.VGfunctionType$_parameters$_type_type_typeLiteral$_property$_type<Annotation> = null
                                                                                const setOptional = () => {
                                                                                    Gtype(node, children, ($) => {
                                                                                        optional = $
                                                                                    })
                                    ...
                                    const choose_typeReference = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_typeReference$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                            ...
                                            let currentChild: uast.Node<Annotation> | undefined
                                            let nextChild: uast.Node<Annotation> | undefined
                                            const sequenceEnd = ($: tast.VTGfunctionType$_parameters$_type_type_typeReference$<Annotation>) => {
                                                callback({
                                                    annotation: node.annotation,
                                                    content: $,
                                                })
                                            }
                                            const choiceEnd_GfunctionType$_parameters$_type_type_typeReference$_referencedType = ($: tast.VTGfunctionType$_parameters$_type_type_typeReference$_referencedType<Annotation>) => {
                                                const _referencedType = $
                                                const elements: tast.VGfunctionType$_parameters$_type_type_typeReference$_parameters<Annotation> = []
                                                const processElement = () => {
                                                    Gtype(node, children, ($) => {
                                                        elements.push($)
                                                    })
                                            ...
                                            if (children.length === 0) {
                                                ...
                                                const choose_qualifiedName = () => {
                                                    ...
                                                    ((
                                                        $: uast.Node<Annotation>,
                                                        callback: ($: tast.NGfunctionType$_parameters$_type_type_typeReference$_referencedType_qualifiedName$<Annotation>) => void,
                                                    ): void => {
                                                        const node = $
                                                        const children: uast.Node<Annotation>[] = []
                                                        $.children.forEach(($) => { children.push($) })
                                                        ...
                                                        let currentChild: uast.Node<Annotation> | undefined
                                                        let nextChild: uast.Node<Annotation> | undefined
                                                        const sequenceEnd = ($: tast.VTGfunctionType$_parameters$_type_type_typeReference$_referencedType_qualifiedName$<Annotation>) => {
                                                            callback({
                                                                annotation: node.annotation,
                                                                content: $,
                                                            })
                                    ...
                                    const choose_union = () => {
                                        ...
                                        ((
                                            $: uast.Node<Annotation>,
                                            callback: ($: tast.NGfunctionType$_parameters$_type_type_union$<Annotation>) => void,
                                        ): void => {
                                            const node = $
                                            const children: uast.Node<Annotation>[] = []
                                            $.children.forEach(($) => { children.push($) })
                                            ...
                                            let currentChild: uast.Node<Annotation> | undefined
                                            let nextChild: uast.Node<Annotation> | undefined
                                            const elements: tast.VGfunctionType$_parameters$_type_type_union$<Annotation> = []
                                            const processElement = () => {
                                                currentChild = children.pop()
                                                if (currentChild === undefined) {
                                                    reportMissingToken({
                                                ...
                                                ((
                                                    ...
                                                    let currentChild: uast.Node<Annotation> | undefined
                                                    let nextChild: uast.Node<Annotation> | undefined
                                                    const sequenceEnd = ($: tast.VTGfunctionType$_parameters$_type_type_union$$<Annotation>) => {
                                                        callback({
                                                            annotation: node.annotation,
                                                            content: $,
                                                        })
                                                    ...
                                                    ((
                                                        $: uast.Node<Annotation>,
                                                        callback: ($: tast.NGfunctionType$_parameters$_type_type_union$$_state$<Annotation>) => void,
                                                    ): void => {
                                                        const node = $
                                                        const children: uast.Node<Annotation>[] = []
                                                        $.children.forEach(($) => { children.push($) })
                                                        ...
                                                        let currentChild: uast.Node<Annotation> | undefined
                                                        let nextChild: uast.Node<Annotation> | undefined
                                                        const choiceEnd_GfunctionType$_parameters$_type_type_union$$_state$ = ($: tast.VTGfunctionType$_parameters$_type_type_union$$_state$<Annotation>) => {
                                                            callback({
                                                                annotation: node.annotation,
                                                                content: $,
                                                            })
                                                        ...
                                                        if (children.length === 0) {
                                                            ...
                                                            const choose_string = () => {
                                                                ...
                                                                ((
                                                                    $: uast.Node<Annotation>,
                                                                    callback: ($: tast.NGfunctionType$_parameters$_type_type_union$$_state$_string$<Annotation>) => void,
                                                                ): void => {
                                                                    const node = $
                                                                    const children: uast.Node<Annotation>[] = []
                                                                    $.children.forEach(($) => { children.push($) })
            ...
            pr.cc(elements, ($) => {
                ...
                ((
                    $: uast.Node<Annotation>,
                    callback: ($: tast.NGfunctionType$_void$<Annotation>) => void,
                ): void => {
                    const node = $
                    const children: uast.Node<Annotation>[] = []
                    $.children.forEach(($) => { children.push($) })
