                ...
                $.forEach(($) => {
                    ((
                        ...
                        pr.cc($.content, ($) => {
                            ...
                            pr.cc($["definition"], ($) => {
                                ((
                                    $: api.TNroot_globals$_definition$<Annotation>,
                                ) => {
                                    if (foo["/.globals/*TypeAliasDeclaration/.definition/*FunctionType"] !== undefined) { foo["/.globals/*TypeAliasDeclaration/.definition/*FunctionType"].begin($) }
                                    pr.cc($.content, ($) => {
                                        pr.cc($["parameters"], ($) => {
                                            X_parameterTriplet($)
                                        })
                                        pr.cc($["void"], ($) => {
                                            ((
                                                $: api.TNroot_globals$_definition$_void$<Annotation>,
                                            ) => {
                                                if (foo["/.globals/*TypeAliasDeclaration/.definition/*FunctionType/.void/*VoidKeyword"] !== undefined) { foo["/.globals/*TypeAliasDeclaration/.definition/*FunctionType/.void/*VoidKeyword"]($) }
                                            })($)
                                        })
                                    })
                                    if (foo["/.globals/*TypeAliasDeclaration/.definition/*FunctionType"] !== undefined) { foo["/.globals/*TypeAliasDeclaration/.definition/*FunctionType"].end($) }
                                })($)
                            })
                        })
