...
export type IVisitor<Annotation> = {
    ...
    readonly "/.globals/*TypeAliasDeclaration/.definition/*FunctionType/.void/*VoidKeyword"?: ($: api.TNroot_globals$_definition$_void$<Annotation>) => void
    readonly "/.globals/*TypeAliasDeclaration/.definition/*FunctionType"?: {
        readonly "begin": ($: api.TNroot_globals$_definition$<Annotation>) => void,
        readonly "end": ($: api.TNroot_globals$_definition$<Annotation>) => void,
    }
