...
export type TVroot_globals$_typeParameters<Annotation> = TVTroot_globals$_typeParameters<Annotation>[]
export type TVTroot_globals$_definition$_parameters<Annotation> = TGparameterTriplet<Annotation>
export type TVroot_globals$_definition$_parameters<Annotation> = TVTroot_globals$_definition$_parameters<Annotation>

export type TNroot_globals$_definition$_void$<Annotation> = Annotation
export type TVTroot_globals$_definition$_void<Annotation> = TNroot_globals$_definition$_void$<Annotation>
export type TVroot_globals$_definition$_void<Annotation> = TVTroot_globals$_definition$_void<Annotation>
export type TVTroot_globals$_definition$<Annotation> = {
    readonly "parameters":  TVroot_globals$_definition$_parameters<Annotation>
    readonly "void":  TVroot_globals$_definition$_void<Annotation>
}
export type TVroot_globals$_definition$<Annotation> = TVTroot_globals$_definition$<Annotation>

export type TNroot_globals$_definition$<Annotation> = TAnnotatedType<Annotation, TVroot_globals$_definition$<Annotation>>
export type TVTroot_globals$_definition<Annotation> = TNroot_globals$_definition$<Annotation>
export type TVroot_globals$_definition<Annotation> = TVTroot_globals$_definition<Annotation>
export type TVTroot_globals$<Annotation> = {
    ...
    readonly "definition":  TVroot_globals$_definition<Annotation>
}
