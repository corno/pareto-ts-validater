...
export function createDefaultVisistor(): f.IVisitor<string> {
    return {
        ...
        "/.interfaces/*TypeAliasDeclaration/.export/*ExportKeyword": ($) => { console.log("/.interfaces/*TypeAliasDeclaration/.export/*ExportKeyword") },
        "/.interfaces/*TypeAliasDeclaration/.typeParameters/*TypeParameter": {
            begin: ($) => { console.log("/.interfaces/*TypeAliasDeclaration/.typeParameters/*TypeParameter begin") },
            end: ($) => { console.log("/.interfaces/*TypeAliasDeclaration/.typeParameters/*TypeParameter end") },
        },
        "/.interfaces/*TypeAliasDeclaration": {
            begin: ($) => { console.log("/.interfaces/*TypeAliasDeclaration begin") },
            end: ($) => { console.log("/.interfaces/*TypeAliasDeclaration end") },
        },
